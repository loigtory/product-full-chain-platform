...
const CAPABILITIES = [
  ...
  },
  {
    ...
    skills: ['rdc-prd-standardizer', 'rdc-feature-point-split'],
    tools: ['对话生成', '材料提取'],
    mcps: [],
  },
  {
    ...
    skills: ['figma-generate-design', 'uml-and-software-architecture-visualization'],
    tools: ['对话生成', '原型画布'],
    mcps: [],
  },
  {
  ...
  },
  {
    ...
    skills: ['platform-test-case-writer', 'platform-test-runner-reporter'],
    tools: ['测试用例生成', '测试执行记录'],
    mcps: [],
  },
  {
  ...
  },
  {
    ...
    skills: ['rdc-data-analysis', 'statistical-and-uncertainty-visualization'],
    tools: ['指标设计', '复盘模板'],
    mcps: [],
  },
];
