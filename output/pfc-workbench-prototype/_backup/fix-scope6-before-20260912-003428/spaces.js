(() => {
  ...
  P.renderDelivery = () =>
    `<main class="guide-page"><div class="page-head"><div><h1>交付中心</h1><p>按同一需求汇总开发、测试、验收、发布和观察，完成状态以关联记录为准。</p></div><div class="actions">${b('open-work', '继续当前作业', { req: P.r()?.id }, 'primary')}${b('deliver-package', i('download') + ' 下载当前需求交付包')}</div></div>${card(
      '交付概览',
      P.table(
        ['需求', '开发', '测试', '验收', '发布', '观察', ''],
